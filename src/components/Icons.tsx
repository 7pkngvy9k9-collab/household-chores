...
const paths: Record<string, string> = {
  ...
  "cat-milk": "M8 8h8v12H8zM10 8V5h4v3M10 13h4",
  "cat-leaf": "M5 19c8-1 12-8 14-15-8 2-14 8-14 15zM8 14c2-1 4-3 5-5",
  "cat-bread": "M5 14c0-4 3-6 7-6s7 2 7 6v4H5zM5 14h14",
  "cat-fish": "M4 12c4-5 10-5 14 0-4 5-10 5-14 0zm14 0 4-3v6zM8 11h.01",
  "cat-jar": "M8 7h8v13H8zM9 7V5h6v2M10 12h4",
  "cat-snow": "M12 3v18M5 6.5 19 17.5M19 6.5 5 17.5M7 12h10",
  "cat-bottle": "M10 4h4l1 4v13H9V8z",
  "cat-spray": "M8 9h8v12H8zM11 5h2v4M14 6h4",
  "cat-drop": "M12 4c0 6-6 8-6 12a6 6 0 0 0 12 0c0-4-6-6-6-12z",
  "cat-paw": "M8 9.5a1.6 1.6 0 1 0 0-3.2 1.6 1.6 0 0 0 0 3.2M12 8a1.6 1.6 0 1 0 0-3.2A1.6 1.6 0 0 0 12 8M16 9.5a1.6 1.6 0 1 0 0-3.2 1.6 1.6 0 0 0 0 3.2M12 21c-3.2 0-5-2.2-5-4.4 0-2 2-3.6 5-3.6s5 1.6 5 3.6C17 18.8 15.2 21 12 21z",
  "cat-basket": "M5 10h14l-1.5 9H6.5zM9 10 11 5h2l2 5",
};
